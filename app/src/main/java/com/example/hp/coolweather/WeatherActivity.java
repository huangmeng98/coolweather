...
public class WeatherActivity extends AppCompatActivity {
    ...
    private CollationElementIterator maxText;
    ...
    public void requestWeather(final String weatherId) {
        String weatherUrl="http://huangmeng98.tech/api/weather?cityid="+weatherId + "&key=bc0418b57b2b4918819d3974ac1285d9";
    ...
    private void loadBingPic(){
        String requestBingPic="http://huangmeng98.tech/api/bing_pic";
...
private void showWeatherInfo(Weather weather){
    ...
    for (Forecast forecast:weather.forecastList){
        ...
        TextView msxText =(TextView) view.findViewById(R.id.max_text);
